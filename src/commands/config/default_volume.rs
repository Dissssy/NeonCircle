...
use crate::{
    commands::music::{AudioCommandHandler, AudioPromiseCommand, MetaCommand},
...
pub struct Song;
#[async_trait]
impl crate::traits::SubCommandTrait for Song {
    fn register_command(&self) -> CreateCommandOption {
        CreateCommandOption::new(
...
pub struct Radio;
#[async_trait]
impl crate::traits::SubCommandTrait for Radio {
    fn register_command(&self) -> CreateCommandOption {
        CreateCommandOption::new(
            CommandOptionType::SubCommand,
            self.command_name(),
